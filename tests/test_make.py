...
def setup_module(test_mock_make_build):
...
def test_mock_make_build():
    ...
    args = ToolBoxParams(f'{MOCK_DIR}/make/tools.yml',
                         build_dir='build',
                         symlink=None,
                         config=[f'{MOCK_DIR}/make/config.yml'],
                         interactive=False,
